    ...
    <nav class="text-white navbar navbar-expand-md navbar-primary alert rosa">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
                ...
                <a class="text-light" href="{{ route('sair') }}">
        ...
        <div class="row container home">
            ...
            <div class="alert alert-primary" id="agenda">
                ...
                <form action="{{ route('funcionario') }}" method="get">
                    ...
                    <label onclick="selecionar({{ $item->id }})" for="{{ $item->id }}" class="alert d-flex justify-content-center rosa s {{ $item->id }} ">
                        ...
                        <h2 class="col-10 }}" style="font-size:20px" >
                            {{ $item->nome }}
                        </h2>
                        <a href="{{ route('removerFuncionario',['id'=> $item->id ]) }}" style="width:30px;" >
            ...
            <div class="alert alert-primary" id="horarios">
                ...
                <div class="container">
                    ...
                    <form class="row mt-1" action="{{ route('alterarTratamento',['id'=> $item->id]) }}" method="post">
                        @csrf
                        <input class="form-control col-4 col-md-6 " type="text" name="nome" value="{{ $item->nome }}">
                        <input class="form-control col-2" type="text" name="valor" value="{{ $item->valor }}">
                        <a class="btn btn-danger col-2 col-md-1" href="{{ route('removerTratamento',['id'=> $item->id]) }}">X</a>
                        <button class="btn btn-success col">Alterar</button>
                    </form>
                    @endforeach
                    ...
                    <div class="card m-0 cart {{ $item->nome }} mt-1  ml-md-4">
                        ...
                        <div class="row m-0 bg-light">
                            ...
                            <div class="" style="width: 35%;">
                                <div style="width: 100%;height:70%;font-size:35px">
                            ...
                            <div class="" style="width: 65%;">
                                ...
                                <a href="https://web.whatsapp.com/send?phone={{ $item->telefone }}" style="width: 100%; height:45px;" class="mb-1 row m-0 card alert-success ">
                                    ...
                                    <div class="mt-2" style="width: 80%;font-size: 15px;">
                                        <b>{{ $item->telefone }}</b>
                                    </div>
                                </a>
                            </div>
