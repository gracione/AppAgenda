...
<body>
    ...
    <div class="col d-flex justify-content-center">
        <form action="{{ route('marcarHorario') }}" method="POST" class="calendario">
            ...
            <div class="calendarioForm alert alert-primary">
                <div class="w-100 text-black d-flex justify-content-center h2" style="height: 10%;">
                    <a href="{{ route('MesAnterior',['add'=> $funcionario]) }}">
                        <img style="transform: rotate(180deg);" width="60px;" src="https://4.bp.blogspot.com/-lwA6dGOaWEU/U1_8q21sQpI/AAAAAAAAMfM/69O45-_omnc/s200/www.png-free.blogspot.com+-+seta+luz+pink.png" alt="">
                    </a>
                    {{ $nomeMes }}
                    <a href="{{ route('proximoMes',['add'=> $funcionario]) }}">
                        <img width="60px;" src="https://4.bp.blogspot.com/-lwA6dGOaWEU/U1_8q21sQpI/AAAAAAAAMfM/69O45-_omnc/s200/www.png-free.blogspot.com+-+seta+luz+pink.png" alt="">
                    </a>
                </div>
            ...
            <!-- Horario -->
            <div class="horarioForm alert alert-primary" style="height:800px;" >
